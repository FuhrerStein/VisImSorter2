...
class Ui_VisImSorter(object):
    def setupUi(self, VisImSorter):
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(10, 220, 351, 70))
        ...
        self.groupBox_7.setGeometry(QtCore.QRect(10, 300, 351, 70))
        ...
        self.slider_max_pairs.setProperty("value", 100)
        ...
        self.lbl_max_pairs.setMinimumSize(QtCore.QSize(60, 0))
        ...
        self.groupBox_9.setGeometry(QtCore.QRect(10, 130, 351, 81))
        self.groupBox_9.setObjectName("groupBox_9")
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(self.groupBox_9)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.btn_angles = QtWidgets.QPushButton(self.groupBox_9)
        self.btn_angles.setCheckable(True)
        self.btn_angles.setChecked(True)
        self.btn_angles.setFlat(True)
        self.btn_angles.setObjectName("btn_angles")
        self.buttonGroup = QtWidgets.QButtonGroup(VisImSorter)
        self.buttonGroup.setObjectName("buttonGroup")
        self.buttonGroup.addButton(self.btn_angles)
        self.horizontalLayout_8.addWidget(self.btn_angles)
        self.btn_distances = QtWidgets.QPushButton(self.groupBox_9)
        self.btn_distances.setCheckable(True)
        self.btn_distances.setFlat(True)
        self.btn_distances.setObjectName("btn_distances")
        self.buttonGroup.addButton(self.btn_distances)
        self.horizontalLayout_8.addWidget(self.btn_distances)
        self.btn_compare_resort = QtWidgets.QPushButton(self.tab_unduplicate)
        self.btn_compare_resort.setGeometry(QtCore.QRect(10, 380, 163, 54))
        self.btn_compare_resort.setCheckable(True)
        self.btn_compare_resort.setChecked(True)
        self.btn_compare_resort.setFlat(True)
        self.btn_compare_resort.setObjectName("btn_compare_resort")
...
"folder images"))
        ...
        self.groupBox_3.setTitle(_translate("VisImSorter", "Drop image pairs less like than"))
        self.lbl_image_max_likeness.setText(_translate("VisImSorter", "5"))
        self.groupBox_7.setTitle(_translate("VisImSorter", "Limit end result to best pairs"))
        self.lbl_max_pairs.setText(_translate("VisImSorter", "5"))
        self.groupBox_9.setTitle(_translate("VisImSorter", "Compare image vectors by"))
        self.btn_angles.setText(_translate("VisImSorter", "Angles"))
        self.btn_distances.setText(_translate("VisImSorter", "Distances"))
        self.btn_compare_resort.setText(_translate("VisImSorter", "Do resort \n"
"after search"))
